...
//Test to make sure the Syscall_Return calculates the correct error code to retrieve the error description
#[test]
fn test_err_return()
{   
    let x: isize = -25;
    match Syscall_Return(x) {
        Ok(num) => assert_eq!(num, x),
        Err(e) => assert_eq!(e, Get_Err_Code(25)),
    };
